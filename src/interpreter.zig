...
pub const Interpreter = struct {
    ...
    fn @"f32.convert_i32_s"(self: *Interpreter, ip: usize, code: []Instruction, sp: usize, stack: []u64, err: *?WasmError) void {
        const c1 = peekOperand(i32, stack, sp, 0);

        putOperand(f32, stack, sp, 0, @intToFloat(f32, c1));

        return @call(.{ .modifier = .always_tail }, dispatch, .{ self, ip + 1, code, sp, stack, err });
    }

    fn @"f32.convert_i32_u"(self: *Interpreter, ip: usize, code: []Instruction, sp: usize, stack: []u64, err: *?WasmError) void {
        const c1 = peekOperand(u32, stack, sp, 0);
    ...
    fn @"f32.convert_i64_s"(self: *Interpreter, ip: usize, code: []Instruction, sp: usize, stack: []u64, err: *?WasmError) void {
        const c1 = peekOperand(i64, stack, sp, 0);
    ...
    fn @"f32.convert_i64_u"(self: *Interpreter, ip: usize, code: []Instruction, sp: usize, stack: []u64, err: *?WasmError) void {
        const c1 = peekOperand(u64, stack, sp, 0);
    ...
    fn @"f32.demote_f64"(self: *Interpreter, ip: usize, code: []Instruction, sp: usize, stack: []u64, err: *?WasmError) void {
        const c1 = peekOperand(f64, stack, sp, 0);

        putOperand(f32, stack, sp, 0, @floatCast(f32, c1));

        return @call(.{ .modifier = .always_tail }, dispatch, .{ self, ip + 1, code, sp, stack, err });
    }

    fn @"f64.convert_i32_s"(self: *Interpreter, ip: usize, code: []Instruction, sp: usize, stack: []u64, err: *?WasmError) void {
        const c1 = peekOperand(i32, stack, sp, 0);

        putOperand(f64, stack, sp, 0, @intToFloat(f64, c1));

        return @call(.{ .modifier = .always_tail }, dispatch, .{ self, ip + 1, code, sp, stack, err });
    }

    fn @"f64.convert_i32_u"(self: *Interpreter, ip: usize, code: []Instruction, sp: usize, stack: []u64, err: *?WasmError) void {
        const c1 = peekOperand(u32, stack, sp, 0);
    ...
    fn @"f64.convert_i64_s"(self: *Interpreter, ip: usize, code: []Instruction, sp: usize, stack: []u64, err: *?WasmError) void {
        const c1 = peekOperand(i64, stack, sp, 0);
    ...
    fn @"f64.convert_i64_u"(self: *Interpreter, ip: usize, code: []Instruction, sp: usize, stack: []u64, err: *?WasmError) void {
        const c1 = peekOperand(u64, stack, sp, 0);
    ...
    fn @"f64.promote_f32"(self: *Interpreter, ip: usize, code: []Instruction, sp: usize, stack: []u64, err: *?WasmError) void {
        const c1 = peekOperand(f32, stack, sp, 0);

        putOperand(f64, stack, sp, 0, @floatCast(f64, c1));

        return @call(.{ .modifier = .always_tail }, dispatch, .{ self, ip + 1, code, sp, stack, err });
    }

    fn @"i32.reinterpret_f32"(self: *Interpreter, ip: usize, code: []Instruction, sp: usize, stack: []u64, err: *?WasmError) void {
        const c1 = peekOperand(f32, stack, sp, 0);

        putOperand(i32, stack, sp, 0, @bitCast(i32, c1));

        return @call(.{ .modifier = .always_tail }, dispatch, .{ self, ip + 1, code, sp, stack, err });
    }

    fn @"i64.reinterpret_f64"(self: *Interpreter, ip: usize, code: []Instruction, sp: usize, stack: []u64, err: *?WasmError) void {
        const c1 = peekOperand(f64, stack, sp, 0);

        putOperand(i64, stack, sp, 0, @bitCast(i64, c1));

        return @call(.{ .modifier = .always_tail }, dispatch, .{ self, ip + 1, code, sp, stack, err });
    }

    fn @"f32.reinterpret_i32"(self: *Interpreter, ip: usize, code: []Instruction, sp: usize, stack: []u64, err: *?WasmError) void {
        const c1 = peekOperand(i32, stack, sp, 0);

        putOperand(f32, stack, sp, 0, @bitCast(f32, c1));

        return @call(.{ .modifier = .always_tail }, dispatch, .{ self, ip + 1, code, sp, stack, err });
    }

    fn @"f64.reinterpret_i64"(self: *Interpreter, ip: usize, code: []Instruction, sp: usize, stack: []u64, err: *?WasmError) void {
        const c1 = peekOperand(i64, stack, sp, 0);

        putOperand(f64, stack, sp, 0, @bitCast(f64, c1));
